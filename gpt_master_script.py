...
# Get file paths.
student_path = input(
    "Please enter the path (likely starting with C:/) of the student files: "
)
input_path = input(
    "Please enter the path of the input files (in the form Input***.txt): "
)
compiler_type = input(
    "Please indicate the compiler you would like to use (1 = CygWin and gcc, 2 = VisualStudio and cl)"
)
